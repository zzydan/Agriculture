...
<!-- 编辑模板模态框（Modal） upTemplateInfo_Modal-->
                ...
                <div class="panel-body">
                    <form id="template_Form_update" class="form-horizontal">
                        ...
                        <div class="form-group" style="margin-top:15px">
                            ...
                            <label class="control-label col-sm-1">作物种类</label>
                            <div class="col-sm-2">
                                <select class="form-control" name="category" id="category_update" onchange="getVarietyList_update()">
                    ...
                    <div class="layui-card" style="height: 453px">
                        <style>
                            #templatePlan_table_update tr th {
                                padding: 1px;
                                height: 37px;
                                font-size: 14px;
                                text-align: center;
                            ...
                            #templatePlan_table_update tr td {
                                padding: 1px;
                                height: 37px;
                                font-size: 14px;
                                text-align: center;
                        ...
                        <table id="templatePlan_table_update"></table>
                    </div>
                </div>
            </div>
            <div class="panel-body">
