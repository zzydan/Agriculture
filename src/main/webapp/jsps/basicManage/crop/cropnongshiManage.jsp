...
<script src="${pageContext.request.contextPath}/static/js/basicManage/corp/cropnongshiManage.js"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width: 1100px;margin-right: 300px">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新增农事</h4>
            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="##" class="form-horizontal" role="form" id="roleForm">
                            <div class="form-group">
                                <label for="name" class="col-md-2 control-label">农事名称</label>
                                <div class="col-sm-4">
                ...
                <div class="panel-group" id="accordion_up">
                    ...
                    <div class="panel-body">
                        <form action="##" class="form-horizontal" role="form" id="roleForm_up">
                            <div class="form-group">
                                <label for="name_up" class="col-md-2 control-label">农事名称</label>
                                <div class="col-sm-4">
