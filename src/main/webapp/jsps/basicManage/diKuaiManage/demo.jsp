...
<div id="result">
    ...
    <input type="button"  value="获取多边形的顶点" οnclick="getPoint()"/><br/>
    <input type="button"  value="开启线、面编辑功能" οnclick="Editing('enable')"/>
    <input type="button"  value="关闭线、面编辑功能" οnclick="Editing('disable')"/>
    <input type="button"  value="显示原有多边形" οnclick="showPolygon(this)" /><br/>

    <input type="button"  value="画多边形" οnclick="draw(BMAP_DRAWING_POLYGON)" />
    <input type="button"  value="画矩形" οnclick="draw(BMAP_DRAWING_RECTANGLE)" />
    <input type="button"  value="画线" οnclick="draw(BMAP_DRAWING_POLYLINE)" />
